...
(() => {
      ...
      slide.querySelectorAll(".process-numeral").forEach((number, i) => {
        play(
          ...
          [
            ...
            { scale: "1.16", opacity: 1, offset: 0.45 },
            { scale: "1", opacity: 1 },
          ],
          650,
          i * 360
  ...
  document.querySelector(".reveal-concern").addEventListener("click", (event) => {
    ...
    play(
      document.querySelector("#access-concern"),
      [{ outline: "4px solid transparent" }, { outline: "4px solid #aa443c", offset: 0.35 }, { outline: "4px solid transparent" }],
      1000
    );
  });
