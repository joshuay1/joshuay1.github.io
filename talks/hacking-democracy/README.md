...
A 30-minute presentation by Joshua C. Yang. The revised talk has 27 scenes, 28 minutes of delivery and two minutes of buffer.

The opening is title → introduction to Joshua → everyday democratic decisions → collective intelligence → four research directions → historical lineage → five-part framework → Kultur Komitee (slide 8). The five parts are Framing, Ideas, Deliberation, Voting and Accountability. They provide a flexible vocabulary for collective intelligence and democratic processes; they can overlap or repeat.

The voting-rule comparison sits in the Voting section. The standalone Swiss initiative/referendum and Swiss AI Futures pages are removed. The funding slide uses the supplied Equal Shares handout, with its original PDF and four local views; the KK26 dashboard is no longer embedded. Murmi and the voting receipts retain Live page / Offline view controls. Murmi opens its public interface showcase, not a populated participant session.

All slides use the same warm cream background. Filled colors remain in elements, diagrams and controls. The closing invites participants to find a process they care about, learn with the people involved and explore what could work better.

Open index.html or serve the directory locally. Use Right/Left or the bottom arrows, O for the overview and N for notes. After interacting inside a website, use the bottom presentation arrows. Use ?view=present&demos=offline for local content only. The PDF uses local explanations. Reading view contains the papers and additional sources.

The bio follows https://joshuacyang.com/ as checked on 6 September 2026: incoming MIT postdoc, PhD from ETH Zurich in 2025, work on Kultur Komitee, StadtIdee, vTaiwan and Murmi. The updated over-CHF-2-million total across three years is Joshua’s confirmed figure. Deployment figures and the separate 2026 receipt data retain their source records.
