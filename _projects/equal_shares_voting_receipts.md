---
layout: page
title: Equal Shares Voting Receipts
description: A public voting-receipt interface for Kultur Komitee Winterthur 2026, showing how Equal Shares turns votes, costs, and equal budgets into explainable project funding.
img: assets/img/kk26.png
importance: -1
category: work
---
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0 d-flex justify-content-center">
        <div style="width: 100%; height: 640px; overflow: hidden; position: relative;">
            <iframe src="https://equalshares.kulturkomitee.win/" title="Kultur Komitee Equal Shares voting receipts preview" style="width: 125%; height: 800px; border: none; transform: scale(0.8); transform-origin: top left; position: absolute; top: 0; left: 0;"></iframe>
        </div>
    </div>
</div>
...
<div class="text-center mt-3">
    <a href="https://equalshares.kulturkomitee.win/" target="_blank" rel="noopener noreferrer" class="btn btn-sm z-depth-0" role="button" style="background-color: var(--global-theme-color); color: var(--global-bg-color);">Open Voting Receipts</a>
    <a href="https://equalshares.kulturkomitee.win/info.html" target="_blank" rel="noopener noreferrer" class="btn btn-sm z-depth-0" role="button" style="background-color: var(--global-theme-color); color: var(--global-bg-color);">Read Method Notes</a>
</div>
